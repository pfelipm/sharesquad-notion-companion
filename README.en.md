...
*   **Sheet Identification:** To robustly identify spreadsheet tabs containing data imported by this tool, Google Sheets' `Developer Metadata` functionality is used. This is more reliable than relying on tab names or specific cell content.
